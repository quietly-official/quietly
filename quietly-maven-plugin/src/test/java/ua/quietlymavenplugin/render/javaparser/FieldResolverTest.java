...
public class FieldResolverTest
{
   ...
   {
      FieldResolutionResult result = FieldResolver.resolveField(AmbiguousCustomer.class, "code",
   ...
   {
      FieldResolutionResult result = FieldResolver.resolveField(FuzzyAmbiguousCustomer.class, "statu",
